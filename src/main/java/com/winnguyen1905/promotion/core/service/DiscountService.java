...
public interface DiscountService {  
    ...
    PagedResponse<DiscountVm> getDiscounts(TAccountRequest accountRequest, SearchDiscountRequest request, Pageable pageable);
    ...
    // // Shop endpoints
    // void createShopDiscount(TAccountRequest accountRequest, UUID shopId, AddDiscountRequest request);
    // PagedResponse<DiscountVm> getShopDiscounts(TAccountRequest accountRequest, UUID shopId, Pageable pageable);
    // void updateShopDiscount(TAccountRequest accountRequest, UUID shopId, UUID id, UpdateDiscountRequest request);
    // void deleteShopDiscount(TAccountRequest accountRequest, UUID shopId, UUID id);
    // void updateShopDiscountStatus(TAccountRequest accountRequest, UUID shopId, UUID id, UpdateDiscountStatusRequest request);
    // void assignShopProducts(TAccountRequest accountRequest, UUID shopId, UUID id, AssignProductsRequest request);
    // // void assignBuyers(TAccountRequest accountRequest, UUID shopId, UUID id, AssignBuyersRequest request);

    // // Customer endpoints
    // PagedResponse<DiscountVm> getAvailableDiscounts(TAccountRequest accountRequest, Pageable pageable);
    // PagedResponse<DiscountVm> getAvailableShopDiscounts(TAccountRequest accountRequest, UUID shopId, Pageable pageable);
    // PagedResponse<DiscountVm> getUserDiscounts(TAccountRequest accountRequest, UUID userId, Pageable pageable);
    // void removeDiscountFromCart(TAccountRequest accountRequest, ApplyDiscountRequest request);
}
