...
public class DatabaseInitializer implements CommandLineRunner {
  ...
  private void initializeDiscounts() {
    ...
    if (discountRepository.count() == 0) {
      ...
      // userDiscountRepository.saveAll(List.of(userDiscount, userDiscount2,
      // userDiscount3));
  ...
  // {
  // // Method commented out - ECommissionPayout entity has been removed
  // }

  // private List<EPromotion> createSamplePromotions() {
  // // Method commented out - EPromotion entity has been removed
  ...
  private List<EDiscount> createSampleDiscounts() {
    ...
    for (int i = 1; i <= 20; i++) {
      ...
      EDiscount discount = EDiscount.builder()
          ...
          .creatorType(i % 2 == 0 ? EDiscount.CreatorType.ADMIN : EDiscount.CreatorType.VENDOR)
